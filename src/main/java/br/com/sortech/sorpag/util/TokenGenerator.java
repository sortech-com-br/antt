...
public class TokenGenerator {
    ...
    public String createToken(Map<String, Object> data) {
        ...
        return createToken(data, new TokenOptions(rightNow.getTime(),null,false,false));
    }
    ...
    public String createTokenNFe(Map<String, Object> data) {
        ...
        return createTokenNFe(data, new TokenOptions(new GregorianCalendar().getTime(),null,false,false));
    }
    ...
    private void validateToken(String functionName, Map<String, Object> data, boolean isAdminToken) {
        boolean containsUid = (data != null && data.containsKey("uidEmpresa"));
        if ((!containsUid && !isAdminToken) || (containsUid && !(data.get("uidEmpresa") instanceof String))) {
            throw new IllegalArgumentException(functionName + ": Data payload must contain a \"uid\" key that must be a string.");
        } else if (containsUid && data.get("uidEmpresa").toString().length() > 256) {
