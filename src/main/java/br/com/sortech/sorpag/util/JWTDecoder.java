...
public class JWTDecoder {
	...
	public String getuid() throws Exception {
	    ...
	    JsonNode jsonNode1 = actualObj.get("d").get("uidEmpresa");
	...
	public String getEmail() throws Exception {
	    ...
	    JsonNode jsonNode1 = actualObj.get("d").get("email");
	    
		return jsonNode1.textValue(); 
	}
	
	public String getNomeUsuario() throws Exception {
	    ...
	    JsonNode jsonNode1 = actualObj.get("d").get("nomeUsuario");
